...
const iconSizes = {
  0: { calendar: 56, whatsapp: 56, instagram: 56 },
  1: { calendar: 44, whatsapp: 44, instagram: 44 },
  2: { calendar: 44, whatsapp: 44, instagram: 44 },
  3: { calendar: 56, whatsapp: 56, instagram: 56 },
}
...
{/*           <img src={star} alt="star" className="w-9 h-9" />
        ...
        <motion.div
          ...
          className="pointer-events-auto flex items-center justify-evenly bg-transparent w-52 pt-1 rounded-b-lg">
            <motion.a
              href=""
              target='_blank'
              rel="noopener noreferrer"
              className='flex justify-center items-center bg-black border border-white rounded-full'
              animate={{ width: sizes.calendar, height: sizes.calendar }}
              transition={{ type: "spring", stiffness: 500, damping: 30 }}
            >
              <img src={calendar} alt="calendar" className="filter brightness-50 invert w-1/2 h-1/2 hover:cursor-pointer" />
            </motion.a>
