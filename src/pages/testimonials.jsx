...
const Testimonials = () => {
  ...
  return (
    <section id='testimonials' className='scroll-mt-18 md:scroll-mt-0 flex flex-col gap-10 items-center justify-center flex-shrink-0 w-screen min-h-screen snap-center snap-always pb-10'>
