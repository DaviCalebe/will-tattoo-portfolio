    ...
    <section id='workshop' className='flex flex-col items-center justify-center flex-shrink-0 gap-10 w-full md:w-screen h-[78rem] md:h-screen snap-center snap-always overflow-hidden'>
        <div className="w-full h-9/12 lg:h-9/12 -mt-10 px-0 lg:px-8">
            ...
            <div className="grid grid-cols-[1fr_1.8fr_1fr] grid-rows-2 p-8 pt-0 gap-6 h-full text-primary">
                ...
                {/* Topo esquerdo */}
                <div className="col-start-1 row-start-1 justify-self-start relative overflow-hidden rounded-lg min-h-[200px] max-w-xs bg-black/50 border border-primary/20 before:absolute before:inset-0 before:bg-black/40">
                ...
                {/* Inferior esquerdo */}
                <div className="col-start-1 row-start-2 justify-self-start relative overflow-hidden rounded-lg min-h-[200px] max-w-xs bg-black/50 border border-primary/20 before:absolute before:inset-0 before:bg-black/40">
                    <div className="relative z-10 h-full grid place-items-center text-center p-3 gap-2">
                ...
                {/* Topo direito */}
                <div className="col-start-3 row-start-1 justify-self-end relative overflow-hidden rounded-lg min-h-[200px] max-w-xs bg-black/50 border border-primary/20 before:absolute before:inset-0 before:bg-black/40">
                    <div className="relative z-10 h-full grid place-items-center text-center p-3 gap-2">
                ...
                {/* Inferior direito */}
                <div className="col-start-3 row-start-2 justify-self-end relative overflow-hidden rounded-lg min-h-[200px] max-w-xs bg-black/50 border border-primary/20 before:absolute before:inset-0 before:bg-black/40">
                    <div className="relative z-10 h-full grid place-items-center text-center p-3 gap-2">
                        <img src={aftercare} className="w-12 h-12" alt="" />
                        <h3 className="text-white font-audiowide text-sm">CUIDADOS</h3>
                        <span className="text-sm">
                            Orientações essenciais para a cicatrização e manutenção da tatuagem, garantindo uma recuperação adequada e preservando sua qualidade.
                        </span>
                    </div>
                </div>
